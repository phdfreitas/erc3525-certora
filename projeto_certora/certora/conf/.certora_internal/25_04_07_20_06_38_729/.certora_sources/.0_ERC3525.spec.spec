methods {
    ...
    function slotOf(uint256)                            external returns (uint256) envfree;
    function balanceOf(uint256)                         external returns (uint256) envfree;
    function balanceOf(address)                         external returns (uint256) envfree;
    function transferFrom(uint256, address, uint256)    external returns (uint256) envfree;
    function getApproved(uint256) returns (address)    external envfree;
