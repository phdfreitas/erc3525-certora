...
hook Sstore _values[KEY uint256 tokenId] uint256 new_value (uint256 old_value) {
    sum_of_values = sum_of_values - old_value + new_value;
}

invariant totalSupplyMatchesSumOfValues() {
    to_mathint(totalSupply()) == sum_of_values;
}
